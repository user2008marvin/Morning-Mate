...
import { Camera, ChevronRight, Sparkles, Upload, ArrowLeft, RefreshCcw } from "lucide-react";
...
export default function Home() {
  ...
  const handleProcess = async () => {
    ...
    try {
      // Simulate API/Canvas processing delay for realism
      ...
      createSubmission({
        data: {
          ...
          email: email || null,
          imageDataUrl: photoUrl // Save original for admin
        }
          ...
          {[1, 2, 3, 4].map(i => (
            <div key={i} className="flex items-center">
              <div className={cn(
                ...
                step >= i ? "bg-primary text-white shadow-md shadow-primary/30" : "bg-muted text-muted-foreground",
                step === i && "ring-4 ring-primary/20"
              )}>
                {i}
              </div>
              {i < 4 && <div className={cn("w-8 sm:w-16 h-1 mx-2 rounded-full transition-colors duration-300", step > i ? "bg-primary" : "bg-muted")} />}
            </div>
          ))}
        </div>
            ...
            >
              <div className="text-center max-w-2xl mx-auto space-y-4">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-foreground leading-tight">
                  Your face. <br/><span className="text-primary italic">Your occasion.</span> <br/>Your perfect look.
                </h1>
            ...
            >
              ...
              <div className="bg-card rounded-3xl p-8 md:p-10 shadow-xl border border-card-border">
                <div className="text-center mb-10">
                  ...
                  <p className="text-muted-foreground">We'll apply the <span className="font-semibold text-foreground">"{look}"</span> makeup look to your face.</p>
                </div>
                ...
                {!photoUrl ? (
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-5 border-t border-border pt-8">
                      <h4 className="font-serif text-xl">Where should we send your results? <span className="text-muted-foreground text-sm font-sans font-normal">(Optional)</span></h4>
            ...
            >
              <div className="text-center space-y-4">
                ...
                <p className="text-lg text-muted-foreground max-w-xl mx-auto">
                  Drag the slider to see your before and after with the <span className="font-semibold text-foreground">"{look}"</span> look.
                </p>
              </div>
