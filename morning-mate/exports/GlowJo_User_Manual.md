# GlowJo — User Manual
**Version 2.2 | getglowjo.com**

---

## What is GlowJo?

GlowJo is a routine app for children aged 3–12. It turns the daily school-morning rush — and the evening wind-down — into a fun, star-earning game that kids actually want to play. Less nagging, fewer late starts, calmer bedtimes.

Kids tap through their tasks one by one, earn stars, hear encouraging voices, and work towards a weekly reward chosen by you.
...
| Age | 3–12 |
| School start time | Used to show a countdown clock |
| Weekly reward | Choose from the list or type your own |
| Tasks to include | Tick the ones that apply |

Tap **Let's Go** and the app is ready for your child.

---

## Morning Routine (Child's Screen)

### Starting the Routine
Hand the phone or tablet to your child. They will see:
- A sleeping sun ☀️ in the centre
- Their name and a "Ready to start?" message
- Their total stars ⭐ and streak 🔥 at the top
...
After completing all tasks the child sees:
- A trophy 🏆 and confetti celebration
...
## Night Routine (Bedtime Mode)

Switch to Night Routine by tapping the **☀️ / 🌙 toggle** at the top of the app screen.
...
> **Note:** The app remembers which mode you last used. If you left it in Night Mode it will open there next time. Use the ☀️/🌙 toggle to switch at any time. If the wrong mode is showing, simply tap the toggle to switch back.
...
### Night Routine Music
Calming ambient music starts automatically when the child taps their **first task**. Starting on the first tap (rather than immediately) ensures the music works reliably on all phones and tablets, which block audio before a user gesture.

### Night Routine Voice
When the night routine starts, Moony greets your child with: *"Are you ready for your bedtime routine, [name]?"* before reading the first task aloud.
...
2. **Second tap** — once the story is finished, tap the task again to complete it and move on to Lights Off.
...
- **Morning mode**: "Good morning! Who's doing their morning routine today?" with a sunny sky background.
- **Night mode**: "Good evening! Who's doing their bedtime routine tonight?" with a dark starry background.
...
Go to **getglowjo.com/parent** (or tap **Parent Dashboard** on the win screen or app menu).

### Child Profiles
Each child card shows:
- Their avatar, name, age, and active tasks
- A **🧩 SEND Mode** row showing whether SEND Mode is currently OFF or ON

Tap **✏️ Edit** to:
- Change their name, age, or school time
- Pick or change the **weekly reward**
...
- Speak your message (e.g. "Come on sweetheart, time to brush those teeth!")
- Tap **Stop** — it saves automatically
- Tap ▶ **Play** to hear it back
- Tap 🗑 **Delete** to remove and re-record

### Tonight's Prep Checklist 🌙
A nightly checklist for parents to get organised the evening before. Available to all users.

Default tasks:
1. Set out school clothes
2. Pack school bag
3. Fill water bottle
4. Prepare lunch / snacks
5. Charge tablet / devices
6. Sign any letters or forms

Tap any task to tick it off. Ticks **reset automatically each morning**. Tap **+** to add your own custom tasks — these carry over every night.

### Week Star Chart
Each child's profile shows a Mon–Sun star chart. Tap **🖨️ Print Chart** to print it and stick it on the fridge.
...
The app supports **English and Spanish** for both morning and night routines. Switch languages using the **EN / ES** toggle buttons flanking the Sunny mascot at the top of the routine screen.

Spanish covers the full experience: task prompts, voice messages, the win screen celebration (spoken and displayed), the done-today screen, bedtime stories, and the WhatsApp / copy share message.
...
|---|---|
| ⭐ (top left) | Total stars earned all time |
| 🔥 (top right) | Current daily streak |
| Weekly circles (Mon–Sun) | Days **this week** the routine was completed — resets every Monday |

When all 7 circles are filled in a single week, the **🏆 Full Week!** celebration banner appears on the win screen, naming the reward earned.

Stars and streaks are saved to your account and sync across devices when logged in.
...
- **Set a routine time**: Open GlowJo at the same time every morning and evening so it becomes habit.
...
- **Use the weekly reward**: Mention it each morning ("Remember, if you do this all week we get Pizza Night!").
...
The app remembers which mode you used last. Tap the ☀️/🌙 toggle at the top to switch back to Morning Mode.
...
**The Story Time story is the same every night**  
...
Website: **getglowjo.com**  
For questions or feedback, use the contact form on the website.

---

*GlowJo — Making mornings (and bedtimes) magical, one star at a time. ⭐*
