...
const TASKS_EN = [
  ...
  {
    emoji: "🧼", label: "WASH YOUR FACE!", sticker: "🌟",
    prompt_en: "Time to wash your face and get bright-eyed and fresh for the day — let's go!",
    prompt_es: "¡Hora de lavarte la cara y sentirte fresco para el día! ¡Vamos!",
    halfway_en: "Almost done — you are doing absolutely brilliantly!",
    halfway_es: "¡Casi terminas! ¡Lo estás haciendo de maravilla!",
    voice_en: "Fresh face done — you look amazing! Well done, superstar!",
    voice_es: "¡Cara lavada! ¡Te ves increíble! ¡Muy bien hecho, superestrella!",
  },
  {
    ...
    voice_en: "You look absolutely wonderful today! Now it's time to take a picture for mummy. One last thing and you are ready!",
    voice_es: "¡Te ves absolutamente maravilloso hoy! Ahora es hora de tomarle una foto a mamá. ¡Una última cosa y estarás listo!",
  },
  {
    emoji: "👟", label: "PUT ON SHOES!", sticker: "💫",
    prompt_en: "Almost there — shoes on and you are ready to go! You can do it!",
    prompt_es: "¡Casi listo! ¡Ponte los zapatos y estarás listo para salir! ¡Tú puedes!",
    halfway_en: "Nearly done — you are a superstar!",
    halfway_es: "¡Casi terminas! ¡Eres una superestrella!",
    voice_en: "Shoes on — brilliant! You are completely ready and looking absolutely amazing! When you are ready to leave, press the Let's Go button.",
    voice_es: "¡Zapatos puestos! ¡Estás completamente listo y te ves absolutamente increíble! Cuando estés listo para salir, presiona el botón Vamos.",
  },
  {
...
// 7 tracks per task — one unique song for every day of the week (Sun=0 … Sat=6)
...
const DEFAULT_MUSIC_POOL = [
  "/music/jump-time.mp3", "/music/cheery-monday.mp3", "/music/brightly-fancy.mp3",
  "/music/friday-morning.mp3", "/music/carefree.mp3", "/music/fun-in-a-bottle.mp3", "/music/happy-bee.mp3",
];
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", marginTop: 16, width: 220, height: 220 }}>
        ...
        >
          {flashSticker ? flashSticker : (!started ? "👍👍" : currentTask ? currentTask.emoji : "🏆")}
        </button>
        {started && currentTask && (
      ...
      <div style={{ fontSize: 14, fontWeight: 700, color: "rgba(255,255,255,0.6)", marginTop: 8 }}>
        {started ? `${Math.min(taskIdx, totalTasks)} / ${totalTasks} tasks` : "Tap 👍👍 to start your morning!"}
      </div>
